...
<div class="container-fluid mt-3">
    <div class="d-flex mb-2">
        <h2 class="fw-bold"> Criar endereço </h2>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('/clientes/endstore', $cliente->id ) }}" method="post">
                <div class="row">
                    @csrf
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            <label for="">CEP<span class="text-danger">*</span></label>
                            <input type="text" name="cep" id="cep"  maxlength="8"class="form-control" placeholder="Digite aqui">
                            @if($errors->has('cep'))
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="rua" id="rua" class="form-control" placeholder="Digite aqui">
                            @if($errors->has('rua'))
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <input type="string" name="numero" class="form-control" placeholder="Digite aqui">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="bairro" id="bairro" class="form-control" placeholder="Digite aqui">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="estado" id="estado" class="form-control" placeholder="Digite aqui">
